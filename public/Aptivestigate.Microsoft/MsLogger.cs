...
namespace Aptivestigate.Microsoft
{
    /// <summary>
    /// Inherited logger class for Microsoft.Extensions.Logging
    /// </summary>
    public class MsLogger : BaseLogger
    {
        ...
        public MsLogger(string name, ILoggerFactory? configurator = null)
        {
            logConfig = configurator ?? LoggerFactory.Create(builder => builder.AddConsole());
